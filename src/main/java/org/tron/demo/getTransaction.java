...
public class getTransaction {
    ...
    public static BigDecimal getValueByTokenDecimals(String value, Long decimals) { if (StringUtils.isEmpty(value)) {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String txHash = "c62b260d96579e621c7f74f2936d587f2a5a34d9d83c0df45475254a255c5d2b";
